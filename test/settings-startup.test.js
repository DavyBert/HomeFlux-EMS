...
assert.equal(localeNl.settings.subtitle, 'v0.8.5 — Jouw energie, anders geregeld');
assert.equal(localeEn.settings.subtitle, 'v0.8.5 — Your energy, managed differently');
...
assert(appJs.includes("settingsSchemaVersion', 69"));
