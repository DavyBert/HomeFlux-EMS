...
assert.equal(localeNl.settings.subtitle, 'v0.8.4 — Jouw energie, anders geregeld');
assert.equal(localeEn.settings.subtitle, 'v0.8.4 — Your energy, managed differently');
