...
assert.equal(localeNl.settings.subtitle, 'v0.7.7 — Jouw energie, anders geregeld');
assert.equal(localeEn.settings.subtitle, 'v0.7.7 — Your energy, managed differently');
