...
assert.equal(localeNl.settings.subtitle, 'v0.4.17 — HomeFlux, jouw energie, anders geregeld');
assert.equal(localeEn.settings.subtitle, 'v0.4.17 — HomeFlux, your energy, managed differently');
