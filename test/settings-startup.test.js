...
assert.equal(localeNl.settings.subtitle, 'v0.8.1 — Jouw energie, anders geregeld');
assert.equal(localeEn.settings.subtitle, 'v0.8.1 — Your energy, managed differently');
