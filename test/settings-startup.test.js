...
assert.equal(localeNl.settings.subtitle, 'v0.8.6 — Jouw energie, anders geregeld');
assert.equal(localeEn.settings.subtitle, 'v0.8.6 — Your energy, managed differently');
