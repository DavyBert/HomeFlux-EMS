...
assert.equal(localeNl.settings.subtitle, 'v0.8.2 — Jouw energie, anders geregeld');
assert.equal(localeEn.settings.subtitle, 'v0.8.2 — Your energy, managed differently');
