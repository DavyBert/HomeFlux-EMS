...
assert.equal(localeNl.settings.subtitle, 'v0.8.3 — Jouw energie, anders geregeld');
assert.equal(localeEn.settings.subtitle, 'v0.8.3 — Your energy, managed differently');
