...
Homey’s complete `{{ … }}` expression envelope is supported, for example
`{{ (5 + [[price]]) * 1.6600000000000001 }}`. At 0.1719 EUR/kWh this
expression evaluates to 8.585354 EUR/kWh: numeric constants are used as supplied.
