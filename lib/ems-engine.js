...
const EV_INSTANCE_DEFAULT_KEYS = [
  ...
  'SmartGridPriority','Weight','BatteryCapacityKwh','TargetSoc','TargetTime','GuaranteeTarget','Phases',
  'MinCurrentA','MaxCurrentA','StandardCurrentA','CommandIntervalSeconds','FeedbackTolerancePercent','SkipFeedbackValidation','PeakGuardStopHoldSeconds',
