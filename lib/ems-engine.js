...
const DEFAULTS = {
  ...
  battery1MinChargeW: 0, battery1MaxChargeW: 2300, battery1MinDischargeW: 0, battery1MaxDischargeW: 2400,
  battery2MinChargeW: 0, battery2MaxChargeW: 2300, battery2MinDischargeW: 0, battery2MaxDischargeW: 2400,
  battery3MinChargeW: 0, battery3MaxChargeW: 2300, battery3MinDischargeW: 0, battery3MaxDischargeW: 2400,
  battery4MinChargeW: 0, battery4MaxChargeW: 2300, battery4MinDischargeW: 0, battery4MaxDischargeW: 2400,
  battery5MinChargeW: 0, battery5MaxChargeW: 2300, battery5MinDischargeW: 0, battery5MaxDischargeW: 2400,
  battery6MinChargeW: 0, battery6MaxChargeW: 2300, battery6MinDischargeW: 0, battery6MaxDischargeW: 2400,
  battery7MinChargeW: 0, battery7MaxChargeW: 2300, battery7MinDischargeW: 0, battery7MaxDischargeW: 2400,
  battery8MinChargeW: 0, battery8MaxChargeW: 2300, battery8MinDischargeW: 0, battery8MaxDischargeW: 2400,
  balanceEnabled: true,
...
function batteryPowerLimits(settings, index) {
  ...
  const minCharge = clamp(asNumber(settings[`battery${battery}MinChargeW`], 0), 0, maxCharge);
  const minDischarge = clamp(asNumber(settings[`battery${battery}MinDischargeW`], 0), 0, maxDischarge);
  return { minCharge, maxCharge, minDischarge, maxDischarge };
}
