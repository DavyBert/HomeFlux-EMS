...
const DEFAULTS = {
  ...
  touRates: [
    { id: 'superdal', name: 'Superdal', importPrice: 0, feedInPrice: 0, weekdayChargeMode: 'night', weekendChargeMode: 'night', nightChargeAllowed: true, dayChargeAllowed: false, avoidGridImport: false, lowForecastDischargeToTarget: false, evChargeAllowed: true, evPvChargeAllowed: true, evPvMinSurplusW: 0, evPvStopGridImportW: 1000, evMaxGridImportW: 0 },
    { id: 'dal', name: 'Dal', importPrice: 0, feedInPrice: 0, weekdayChargeMode: 'day', weekendChargeMode: 'day', nightChargeAllowed: false, dayChargeAllowed: true, avoidGridImport: false, lowForecastDischargeToTarget: false, evChargeAllowed: false, evPvChargeAllowed: true, evPvMinSurplusW: 0, evPvStopGridImportW: 1000, evMaxGridImportW: 0 },
    { id: 'piek', name: 'Piek', importPrice: 0, feedInPrice: 0, weekdayChargeMode: 'never', weekendChargeMode: 'never', nightChargeAllowed: false, dayChargeAllowed: false, avoidGridImport: true, lowForecastDischargeToTarget: false, evChargeAllowed: false, evPvChargeAllowed: true, evPvMinSurplusW: 0, evPvStopGridImportW: 1000, evMaxGridImportW: 0 },
  ],
  touSchedule: [
...
const EV_INSTANCE_DEFAULT_KEYS = [
  ...
  'PeakGuardBatteryAssistNormal','PeakGuardBatteryAssistEmergency','FixedChargeWindowEnabled','DynamicCheapEnabled','DynamicNormalEnabled','DynamicExpensiveEnabled',
];
